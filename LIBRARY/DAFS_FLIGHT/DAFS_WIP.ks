//WORKING ON
    ...
    //TESTING
        ...
        //  - Testing flight test functionality
        //      - Need mode style to make steps work

//CHECK & LOAD SETTINGS FROM PREVIOUS FLIGHT
print "Checking for and loading settings from previous flights".
doLoadSettings().
