...
//GUI LAYOUT
//TITLE
g:addlabel("<b>" + "DASKRUSTY AUTOMATED FLIGHT SYSTEM" + "</b>" + "<i>" + "                                       V0.02.56" + "</i>"). //Title
//HEADER
...
set MAIN_BOX to g:addhlayout.
    local RUNMODE to MAIN_BOX:addvlayout.
        ...
        set RUNMODE:style:align to "left".
            ...
            set NAV to RUNMODE:addbutton ("Navigation").        //NEW
...
set NAV_BOX to g:addhlayout.                                //NEW
    ...
    local MID_SEC to NAV_BOX:addvlayout.
        ...
        //HEADING
            //Setup - B1"<<" B2"<" T"" B3">" B4">>" 
        //HEIGHT
    local RIG_SEC to NAV_BOX:addvlayout.                    //NEW
...
wait until vessel:status:LANDED. {                      //NEW
    TKO:show.
}
